...
This project is indexed by GitNexus as **family-finance-app** (461 symbols, 885 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
