...
export const INITIAL_CATEGORIES: Category[] = [
  { id: 'cat_tieu_vat_thang', month: '2026-08', name: 'Tiêu vặt Thắng', kind: 'EXPENSE', icon: 'User', color: '#3b82f6', dailySpend: true, ownerScope: 'THANG', isActive: true },
  { id: 'cat_tieu_vat_van', month: '2026-08', name: 'Tiêu vặt Vân', kind: 'EXPENSE', icon: 'Heart', color: '#ec4899', dailySpend: true, ownerScope: 'VAN', isActive: true },
  { id: 'cat_an_ngoai', month: '2026-08', name: 'Ăn ngoài & Cafe', kind: 'EXPENSE', icon: 'Coffee', color: '#f97316', dailySpend: true, ownerScope: 'ALL', isActive: true },
  { id: 'cat_xang_xe', month: '2026-08', name: 'Xăng xe & Di chuyển', kind: 'EXPENSE', icon: 'Car', color: '#6366f1', dailySpend: true, ownerScope: 'ALL', isActive: true },
  { id: 'cat_mua_sam', month: '2026-08', name: 'Mua sắm gia đình', kind: 'EXPENSE', icon: 'ShoppingBag', color: '#8b5cf6', dailySpend: true, ownerScope: 'ALL', isActive: true },
  { id: 'cat_sieu_thi', month: '2026-08', name: 'Đi chợ & Siêu thị', kind: 'EXPENSE', icon: 'ShoppingCart', color: '#10b981', dailySpend: true, ownerScope: 'ALL', isActive: true },
  { id: 'cat_tien_nha', month: '2026-08', name: 'Tiền nhà & Chung cư', kind: 'EXPENSE', icon: 'Home', color: '#0ea5e9', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_tien_co_dinh', month: '2026-08', name: 'Điện, Nước & Net', kind: 'EXPENSE', icon: 'Zap', color: '#eab308', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_bao_hiem', month: '2026-08', name: 'Bảo hiểm nhân thọ', kind: 'EXPENSE', icon: 'ShieldCheck', color: '#14b8a6', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_hoc_tap', month: '2026-08', name: 'Học tập & Sách', kind: 'EXPENSE', icon: 'BookOpen', color: '#84cc16', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_lam_dep', month: '2026-08', name: 'Làm đẹp & Chăm sóc', kind: 'EXPENSE', icon: 'Sparkles', color: '#f43f5e', dailySpend: true, ownerScope: 'VAN', isActive: true },
  { id: 'cat_ve_bac_ninh', month: '2026-08', name: 'Về Bắc Ninh', kind: 'EXPENSE', icon: 'Navigation', color: '#64748b', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_ve_ha_tinh', month: '2026-08', name: 'Về Hà Tĩnh', kind: 'EXPENSE', icon: 'MapPin', color: '#78716c', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_chi_cho_con', month: '2026-08', name: 'Chi cho con (Xoài)', kind: 'EXPENSE', icon: 'Baby', color: '#06b6d4', dailySpend: true, ownerScope: 'ALL', isActive: true },
  { id: 'cat_linh_tinh', month: '2026-08', name: 'Linh Tinh / Khác', kind: 'EXPENSE', icon: 'MoreHorizontal', color: '#94a3b8', dailySpend: true, ownerScope: 'ALL', isActive: true },
  // Income
  { id: 'cat_luong_thang', month: '2026-08', name: 'Lương Thắng', kind: 'INCOME', icon: 'Briefcase', color: '#2563eb', dailySpend: false, ownerScope: 'THANG', isActive: true },
  { id: 'cat_luong_van', month: '2026-08', name: 'Lương Vân', kind: 'INCOME', icon: 'Award', color: '#db2777', dailySpend: false, ownerScope: 'VAN', isActive: true },
  { id: 'cat_thuong_khac', month: '2026-08', name: 'Thưởng & Thu nhập ngoài', kind: 'INCOME', icon: 'Gift', color: '#16a34a', dailySpend: false, ownerScope: 'ALL', isActive: true },
  { id: 'cat_mung_cuoi', month: '2026-08', name: 'Mừng cưới / Thôi nôi', kind: 'INCOME', icon: 'Coins', color: '#ca8a04', dailySpend: false, ownerScope: 'ALL', isActive: true },
];
